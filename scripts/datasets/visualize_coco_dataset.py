...
DEFAULT_DATASET_DIRPATH = FIFTYONE_DATASETS_DIRPATH / "coco-2017"
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Visualize COCO dataset annotations.",
...
def main() -> None:
    ...
    logger.info(f"Creating dataset `COCO` (split: {args.split}) from path: '{args.dataset_dirpath}'")
